...
int ERZ::decode(unsigned char * src, int filesize, unsigned char* result, int& fileSizeCompressed)
{
	...
	length = U32(buff+0x2004);
	memcpy(result, (buff+0x100000), U32(buff+0x2004));
    free(buff);
